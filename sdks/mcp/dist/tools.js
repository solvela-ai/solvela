...
exports.TOOLS = [
    {
        name: 'chat',
        description: 'Send a prompt to a specific LLM model through the RustyClawRouter gateway. ' +
        ...
        inputSchema: {
            ...
            properties: {
                model: {
                    type: 'string',
                    description: 'Model identifier, e.g. "openai/gpt-4o", "anthropic/claude-sonnet-4", ' +
    ...
    {
        name: 'smart_chat',
        description: 'Send a prompt using the gateway smart router — it automatically picks the ' +
    ...
    {
        name: 'wallet_status',
        description: 'Check the status of the configured Solana wallet and gateway connectivity. ' +
    ...
    {
        name: 'list_models',
        description: 'List all LLM models available through the RustyClawRouter gateway, ' +
        ...
        inputSchema: {
            ...
            properties: {
                filter: {
                    type: 'string',
                    description: 'Optional substring filter to narrow results, e.g. "gpt", "claude", "gemini".',
                },
            },
            required: [],
        },
    ...
    {
        name: 'spending',
        description: 'Show USDC spending statistics for the current session: total USDC spent, ' +
