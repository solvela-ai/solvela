...
- Test with LiteSVM (fast, in-process) — see full patterns below
...
a manual `/skillsinit` call. For the full skill (IDL codegen, Pinocchio, Surfpool,
confidential transfers) run `/skillsinit solana-dev`.
