...
Channel vouchers are accepted on `/v1/chat/completions`, `/v1/messages`, `/v1/search`, and the [A2A paid leg](/docs/concepts/a2a#channel-vouchers-on-a2a) (`message/send`). Opening and closing a channel are always REST + Solana-signer flows; only the draws differ per surface.
