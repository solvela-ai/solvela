...
| `solana_price` | Get live USD prices for 1–50 base58 SPL mints — per-mint price, decimals, and 24h change (`null` for mints the upstream can't price). Always available; no escrow mode required |
