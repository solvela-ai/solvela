...
<CardGroup>
  ...
  <Card title="Transparent pricing" description="Pay exact provider cost on the hosted gateway. Configurable platform fee (default 5%) on self-hosted. All pricing exposed at GET /pricing." href="/docs/concepts/pricing" />
  <Card title="Agent-to-agent (A2A)" description="Solvela implements the A2A protocol. Other agents can discover and pay via GET /.well-known/agent-card.json." href="/docs/api" />
</CardGroup>
