            ...
            <ul className="space-y-1">
              <li>
                <Link
                  href="/docs"
                  onClick={onClose}
                  className="flex items-center gap-3 py-2 px-2 text-sm text-foreground font-medium hover:bg-[var(--card)] rounded-md transition-colors min-h-[44px]"
                >
                  <span className="flex items-center justify-center w-7 h-7 rounded-md bg-[var(--card)]">
                    <svg aria-hidden="true" className="w-4 h-4 text-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    return (
      <div>
        <button
          ...
          className="flex items-center justify-between w-full py-2 px-2 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted rounded-md transition-colors min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground focus-visible:ring-inset"
        >
          <span>{node.name}</span>
          <svg
            aria-hidden="true"
    ...
    <li className="list-none">
      <Link
        ...
        className={cn(
          ...
          isActive
            ? 'text-foreground font-medium bg-[var(--card)]'
